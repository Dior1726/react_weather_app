...
const userImg = 'https://media.istockphoto.com/vectors/head-of-bearded-man-in-profile-vector-id1262277544?k=20&m=1262277544&s=612x612&w=0&h=ox0ygKKnM45lOfqJXcrAGgwWbMuxEAySR7QAUXRkWC8='
...
const activeClass = 'bg-white w-full py-3 flex items-center justify-center mb-4 rounded-xl text-white bg-opacity-20'

const defaultClass = 'bg-white text-gray-400 bg-opacity-10 w-full py-3 flex items-center justify-center mb-4 rounded-xl hover:text-white hover:bg-opacity-20'
      ...
      <div className=' flex-grow p-5 flex flex-col justify-between'>
        ...
        <div className='flex flex-col items-center gap-5'>
          ...
          <div className='w-14 h-14 shadow-md rounded-full shadow-red-400'>
            <img className='w-full h-auto rounded-full' src={userImg} alt="" />
          </div>
        </div>
      </div>
